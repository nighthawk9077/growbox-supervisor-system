...
def startup():
    ...
    #   __  ___          ___ ____      ___ ______   __      ____          
    #  /_ |/ _ \        / _ \___ \    |__ \____  |  \ \    / /_ |   /\    
    ...
    print("    \  /  __/ |  \__ \ | (_) | | | |_ ")
    time.sleep(0.25)
    print("     \/ \___|_|  |___/_|\___/|_| |_ (_)")
    time.sleep(0.25)
    print("")
    time.sleep(0.25)
    print("  __  ___          ___ ____      ___ ______   __      ____          ")
    time.sleep(0.25)
    print(" /_ |/ _ \        / _ \___ \    |__ \____  |  \ \    / /_ |   /\    ")
    time.sleep(0.25)
    print("  | | (_) |______| | | |__) |_____ ) |  / /____\ \  / / | |  /  \   ")
    time.sleep(0.25)
    print("  | |\__, |______| | | |__ <______/ /  / /______\ \/ /  | | / /\ \  ")
    time.sleep(0.25)
    print("  | |  / /       | |_| |__) |    / /_ / /        \  /   | |/ ____ \ ")
    time.sleep(0.25)
    print("  |_| /_/         \___/____/    |____/_/          \/    |_/_/    \_\ ")
    print("\n\n")
    # ---------------------------------------------------------------------------------------
    # turn on LEDs
    setText("GROWSS IS\n" + "STARTING...")
